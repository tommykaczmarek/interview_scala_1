...
/**
  ...
  * O = Off
  *
  * https://www.thevintagenews.com/2017/02/08/mengenlehreuhr-the-berlin-clock-that-shows-time-with-the-help-of-light-signals-and-a-mathematical-theory/
  *
  * THIS FILE SHOULD REMAIN NOT CHANGED
  *
  */
trait BerlinClock {
  def convert(time: String): Seq[String]
}